...
public class Nivel_3Activity extends AppCompatActivity {

    private FirebaseFirestore db;
    private FirebaseAuth auth;
    private String userId;

    private String nivelActual = "animales";
        ...
        if (completado) {
            db.collection("usuario")
                    ...
                    .addOnSuccessListener(unused -> {
                        ...
                        Intent intent = new Intent(Nivel_3Activity.this, Nivel_completado.class);

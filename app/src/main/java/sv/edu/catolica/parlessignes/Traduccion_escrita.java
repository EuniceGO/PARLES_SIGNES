...
public class Traduccion_escrita extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inputTexto = findViewById(R.id.editText); // Asegúrate de ponerle `android:id="@+id/editText"` al EditText
        btnCheck = findViewById(R.id.btnCheck);

        btnCheck.setOnClickListener(v -> {
            String texto = inputTexto.getText().toString().toLowerCase();
    ...
    private void mostrarSenias(String texto) {
        ...
        int sizeImagen = (int) (80 * getResources().getDisplayMetrics().density);

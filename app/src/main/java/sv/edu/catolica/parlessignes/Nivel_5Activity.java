...
public class Nivel_5Activity extends AppCompatActivity {

    private FirebaseFirestore db;
    private FirebaseAuth auth;
    private String userId;

    private String nivelActual = "mixto";
        ...
        if (completado) {
            db.collection("usuario")
                    ...
                    .addOnSuccessListener(unused -> {
                        ...
                        Intent intent = new Intent(Nivel_5Activity.this, NivelesFinalizadosActivity.class);

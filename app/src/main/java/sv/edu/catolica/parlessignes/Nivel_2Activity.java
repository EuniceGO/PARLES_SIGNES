...
public class Nivel_2Activity extends AppCompatActivity {

    private FirebaseFirestore db;
    private FirebaseAuth auth;
    private String userId;

    private String nivelActual = "numeros";
        ...
        if (completado) {
            db.collection("usuario")
                    ...
                    .addOnSuccessListener(unused -> {
                        ...
                        Intent intent = new Intent(Nivel_2Activity.this, Nivel_completado.class);
